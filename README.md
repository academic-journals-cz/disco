...
-**JMEF plugin** – The DISCO plugin checks whether you are using the JMEF format plugin.
-**iThenticate plugin** – The DISCO plugin checks whether you are using the plugin for plagiarism detection.
-**Knowledge Base** – The DISCO plugin is connected to the Knowledge Base via links, providing access to information about databases.
