...
<form class="pkp_form" id="discoDiamondForm" method="post" action="{$actionUrl}">
    {csrf}
    {fbvFormArea id="diamondFormAreaPersistantIdentification" class="border"}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondPersistantIdentification">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondPersistantIdentification" class="info-content" style="display: none;">
                    {translate key="plugins.generic.disco.diamond.persistantIdentification.description"}
                    <p><strong>{translate key="plugins.generic.disco.services"}:</strong> {translate key="plugins.generic.disco.ddh"}</p>
                </div>
            </div>
      {/fbvFormArea}
      {fbvFormArea id="diamondFormAreaScholarlyJournal" class="border"}
            {if $scholarlyJournal}
                {assign var="checked" value=true}
            {else}
                {assign var="checked" value=false}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondScholarlyJournal">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondScholarlyJournal" class="info-content" style="display: none;">
    ...
    {/fbvFormArea}
    {fbvFormArea id="diamondFormAreaOpenLicence" class="border"}
            {if $openLicence}
                {assign var="checked" value=true}
            {else}
                {assign var="checked" value=false}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondOpenLicence">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondOpenLicence" class="info-content" style="display: none;">
    ...
    {/fbvFormArea}
    {fbvFormArea id="diamondFormAreaNoCharges" class="border"}
            {if $noCharges}
                {assign var="checked" value=true}
            {else}
                {assign var="checked" value=false}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondNoCharges">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondNoCharges" class="info-content" style="display: none;">
    ...
    {/fbvFormArea}
    {fbvFormArea id="diamondFormAreaOpenAuthorship" class="border"}
            {if $openAuthorship}
                {assign var="checked" value=true}
            {else}
                {assign var="checked" value=false}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondOpenAuthorship">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondOpenAuthorship" class="info-content" style="display: none;">
    ...
    {/fbvFormArea}
    {fbvFormArea id="diamondFormAreaOwnershipScience" class="border"}
            {if $ownershipScience}
                {assign var="checked" value=true}
            {else}
                {assign var="checked" value=false}
            ...
            <div class="info-block">
                <a href="javascript:void(0);" class="toggle-btn" data-target="infoDiamondOwnershipScience">
                    <span class="arrow">&#9654;</span> <!-- Šipka doprava -->
                    <span class="toggle-text">More information</span>
                </a>
                <div id="infoDiamondOwnershipScience" class="info-content" style="display: none;">
