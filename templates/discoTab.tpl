...
<tab id="disco" label="{translate key="plugins.generic.disco.disco"}">
    <div id="disco_description" style="margin-bottom: 25px; border-bottom: 1px solid #ddd; text-align: justify;">
        ...
        <tabs :is-side-tabs="true">
            ...
            <tab id="disco_information" label="{translate key="plugins.generic.disco.journalDescription"}">
                {include file="{$discoJournalDescription}"}
            </tab>
            <tab id="disco_landing_pages" label="{translate key="plugins.generic.disco.lpGalleys"}">
                {include file="{$discoLandingPages}"}
            </tab>
            <tab id="disco_metadata" label="{translate key="plugins.generic.disco.metadataRequirements"}">
            ...
            <tab id="disco_policy" label="{translate key="plugins.generic.disco.journalPolicy"}">
