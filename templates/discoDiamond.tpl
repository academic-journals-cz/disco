...
{assign var="diamondArray" value=$categorizedRequirements["diamond"]}
...
<form class="pkp_form" method="put" action="{$actionUrl}">
    ...
    {foreach from=$diamondArray key=requirement item=services}
        {include file="{$discoItem}" category="diamond" requirement=$requirement services=$services}
    {/foreach}
